  ...
  return (
    ...
    >
      <Box sx={{ display: 'flex', alignItems: 'center', pb: 1.5, gap: 1 }}>
        ...
        <Typography fontWeight="lg">Gona_Binli</Typography>
      ...
      <Box sx={{ px: 2 }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', pb: 1 }}>
          ...
          Follow your heart and do what makes you happy 💖 Life is too short to not pursue your passions and dreams. #FindYourPassion #ChaseYourDreams #HappinessIsKey #DoWhatYouLove ❤️✨🌈🌟
          </Typography>
        </Box>
