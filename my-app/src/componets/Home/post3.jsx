...
export default function InstagramPost3() {
  const [likes, setLikes] = React.useState(2003); 
  ...
  return (
    ...
    >
      <Box sx={{ display: 'flex', alignItems: 'center', pb: 1.5, gap: 1 }}>
        ...
        <Typography fontWeight="lg">Shaik_Sohel</Typography>
      ...
      <Box sx={{ px: 2 }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', pb: 1 }}>
          ...
          🔥 Confidence level: 💯 Ready to take on the world!
          </Typography>
        </Box>
