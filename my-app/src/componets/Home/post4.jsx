...
export default function InstagramPost4() {
  ...
  return (
    ...
    >
      <Box sx={{ display: 'flex', alignItems: 'center', pb: 1.5, gap: 1 }}>
        ...
        <Typography fontWeight="lg">Gopi_Srinivas</Typography>
      ...
      <Box sx={{ px: 2 }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', pb: 1 }}>
          ...
          "Snapping pics and capturing memories 📸🌟 #MemoriesForDays #SelfieGameStrong"
          </Typography>
        </Box>
